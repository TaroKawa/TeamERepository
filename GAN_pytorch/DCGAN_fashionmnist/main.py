...
parser.add_argument('--ndf', type=int, default=32, help='number of discriminator feature map')
parser.add_argument('--ngf', type=int, default=32, help='number of generator feature map')
...
dataset = datasets.FashionMNIST(args.data_dir, download=True, transform=trans)
